...
class CaptioningTask(FairseqTask):
    ...
    def add_args(parser):
        ...
        parser.add_argument('--labels-dir', default='output',
                            help='image labels directory')
    ...
    def load_dataset(self, split, **kwargs):
        ...
        labels_dir = os.path.join(self.args.labels_dir)
        ...
        labels_ds = data.LabelsDataset(labels_dir, image_ids)
