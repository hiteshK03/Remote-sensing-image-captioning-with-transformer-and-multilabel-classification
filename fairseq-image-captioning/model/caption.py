...
class CaptioningModel(BaseFairseqModel):
    ...
    def build_model(cls, args, task):
        ...
        return cls.do_build_model(encoder, decoder_cap)

    @classmethod
    def do_build_model(cls, encoder, decoder_cap):
    ...
    def __init__(self, encoder, decoder_cap):
        super().__init__()
...
class DefaultCaptioningModel(CaptioningModel):
    ...
    @classmethod
    def do_build_model(cls, encoder, decoder_cap):
        return DefaultCaptioningModel(encoder, decoder_cap)
